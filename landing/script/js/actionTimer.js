function actionTimer() {
    document.addEventListener('DOMContentLoaded', () => {
        const newYear = new Date('Nov 16 2022 00:00:00'); //Start Date

        //ASSIEGMENT OG SELECTORS TO VARIABLES
        ...
        //DETERMINING THE TIME AND ADDING A NEW VALUE AFTER A CERTAIN TIME INTERVAL, WHIS IN THIS CASE CHANGE EVERY SECOND
